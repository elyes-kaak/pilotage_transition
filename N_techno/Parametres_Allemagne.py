...
# Paramètres globaux
T_life = [12, 25, 30, 30]   # durées de vie des techno carbonées
demande_ini = 513   # demande énergétique
X_j = [1000, 100, 100, 1000, 50] # productions maximales des techno décarbonées
X_jF = [0, 0, 0, 0] # valeurs finales des techno carbonées

ci_car = [49.97, 75.7225, 102, 170] # coûts initiaux (variables) des techno carbonées

p_0 = [0.273931702, 0.53294446, 0.176088372, 0.017035466] # part des technologies carbonées dans le mix initial
p_1 = [0.273931702, 0.53294446, 0.176088372, 0.017035466] # part des technologies carbonées dans le mix initial

ci_decar = [105.81, 125, 177.5, 328.45, 90] # coûts initiaux des techno décarbonées
